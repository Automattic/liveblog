      ...
      <div className="liveblog-entry-tools">
        {
          this.isEditing()
            ? <button className="button button-large
              liveblog-btn liveblog-btn-small" onClick={this.close}>
              Close Editor
            </button>
            : <button className="button button-large
              liveblog-btn liveblog-btn-small" onClick={this.edit}>
              Edit
            </button>
        }
        <button
          className="button button-large button-link-delete
            liveblog-btn liveblog-btn-small liveblog-btn-delete"
          onClick={this.delete}
        >
          Delete
        </button>
