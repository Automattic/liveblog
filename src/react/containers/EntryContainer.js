...
class EntryContainer extends Component {
 constructor(props) {
    ...
    this.createMarkup = () =>  { return {__html: this.props.entry.content }; }
    this.edit = () =>  { 
  ...
  entryActions() {
    ...
    return (
      <div className="wpcom-liveblog-entry-actions">
        <button className="wpcom-liveblog-entry-actions-edit" onClick={this.edit}>Edit</button>
        <button className="wpcom-liveblog-entry-actions-delete" onClick={this.delete}>Delete</button>
      </div>
    )
  }
  
  render() {
    if ( this.props.user.entries[this.props.entry.id] && this.props.user.entries[this.props.entry.id].isEditing ) {
      return (
    ...
    return (
      <div className="wpcom-liveblog-entry">
        <div className="wpcom-liveblog-entry-content" dangerouslySetInnerHTML={this.createMarkup()} />
        {this.entryActions()}
      </div>
    )
  }
