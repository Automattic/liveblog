...
class Media extends Component {
	...
	renderMediaImages() {
		...
		if (images.length === 0) {
			return (
				<div className="liveblog-placeholder liveblog-media-loading">
					<div className="liveblog-placeholder-inner">
						<div style={{ marginBottom: ".5rem" }}>No Images Found</div>
						<span
	...
	renderCurrentImage() {
				...
				<div className="liveblog-placeholder liveblog-media-loading">
					<div className="liveblog-placeholder-inner">
						...
						<div
							...
							className="liveblog-placeholder-text"
						>
							Uploading...
						</div>
					</div>
		...
		return (
			<div className="liveblog-placeholder liveblog-media-loading">
				<div className="liveblog-placeholder-inner">
					<div style={{ marginBottom: ".5rem" }}>No Image Selected</div>
					<span
						style={{ display: "inline-block" }}
						onMouseDown={(e) => e.preventDefault()}
					>
					...
					<div className="liveblog-editor-actions">
						...
						>
							<button
								...
								onClick={
									!edit ? () => setEditMode(true) : this.cancel.bind(this)
								}
							>
								{!edit ? "Change Image" : "Cancel"}
							</button>
						</span>
						{edit && (
							<span
