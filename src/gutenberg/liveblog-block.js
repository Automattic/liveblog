...
(function () {
  ...
  registerBlockType('gutenberg/liveblog', {
    ...
    edit({ attributes, className, setAttributes, focus }) {
      ...
      const doStatusChange = statusChange => setAttributes({ status: statusChange });
        ...
        <section className={className}>
          ...
          <div style={styles[showOptions]}>
            <div style={styles[status === 'enable' ? 'hide' : 'show']}>
              ...
              <p>
                Enables liveblog on this post.
                Posting tools are enabled for editors, visitors get the latest updates.
              </p>
            </div>
