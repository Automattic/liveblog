<div id="liveblog-entry-<?php echo esc_attr( $entry_id ); ?>" class="<?php echo esc_attr( $css_classes ); ?>" data-timestamp="<?php echo esc_attr( $timestamp ); ?>">
	<header class="liveblog-meta">
		...
		<span class="liveblog-meta-time"><a class="liveblog-time-update" href="#liveblog-entry-<?php echo esc_attr( $entry_id ); ?>"><span class="date"><?php echo esc_html( $entry_date ); ?></span><span class="time"><?php echo esc_html( $entry_time ); ?></span></a></span>
	</header>
