...
<?php
	...
	echo wp_kses(
		sprintf( $format_string, $template_variables['wp_version'], $template_variables['min_version'], esc_url( admin_url( 'update-core.php' ) ), esc_url( admin_url( 'plugins.php#liveblog' ) ) ),
		[ 'a' => [ 'href' => [] ] ]
	); 
	?>
</p>
