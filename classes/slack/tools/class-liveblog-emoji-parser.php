...
/**
 * Convert emoji from names to code points.
 */
class Liveblog_Emoji_Parser {
	...
	public static function convert_code_points( $code_points ) {
		$entities = '&#x' . str_replace( '-', ';&#x', $code_points ) . ';';
	...
	public static function convert( $content ) {
		$content = preg_replace_callback(
			'/:([a-z_]+):/',
			function( $matches ) {
				if ( isset( Liveblog_Emoji_Parser::$map[ $matches[1] ] ) ) {
					return self::convert_code_points( Liveblog_Emoji_Parser::$map[ $matches[1] ] );
				} else {
					return $matches[0];
				}
			},
